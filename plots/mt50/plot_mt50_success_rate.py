...
for m in range(int(len(monitor)/values_combined)):
    ...
    non_weighted_average_success_rates.append(avg_s_rate / 50)
...
ax.plot(x_intervals, non_weighted_average_success_rates, linewidth=1.3 , label="Equally Weighted Success Rate")
